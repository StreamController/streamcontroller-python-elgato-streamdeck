...
def render_key_image(deck, icon_filename, font_filename, label_text):
    ...
    draw.line([0, image.height/2, image.width, image.height / 2], width=1)
    draw.line([0, image.height/4, image.width, image.height / 4], width=1)
    draw.line([0, 3*image.height/4, image.width, 3*image.height / 4], width=1)

    draw.line([image.width / 2, 0, image.width/2, image.height], width=1)
    draw.line([image.width / 4, 0, image.width/4, image.height], width=1)
    draw.line([3*image.width / 4, 0, 3*image.width/4, image.height], width=1)
